      ...
      <div className="main-container">
        ...
        <div  className="coin-input-content">
          ...
          <div className={getClass(0)}>
              ...
              <input type="text" id="coin-name" placeholder="Enter your Coin" className="coin-name" />
          ...
          <div className={getClass(1)}>
              ...
              <input type="number" name="holdings" placeholder="Coin amount" id="holdings" /></label>
            ...
            <div className={getClass(4)}>
                <label htmlFor="user-email" className="label-email">Enter your email & password
                    <input type="email" name="user-email" placeholder="a@example.com" id="user-email" aria-autocomplete="inline" />
                </label>
                ...
                <label htmlFor="user-confirm-pass" className="label-confirm-pass">
                    <input type="password" name="user-confirm-pass" placeholder="Confirm password" id="user-confirm-pass" />
                </label>
                <div className="btn-section">
                <button onClick={prevStep} className="go-back-btn"><i className="fa-solid fa-chevron-left"></i> back </button>
              <button onClick={nextStep} className="move-from-holdings">Next <i className="fa-solid fa-chevron-right"></i></button>
